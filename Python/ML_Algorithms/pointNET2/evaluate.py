...
SHAPE_NAMES = [line.rstrip() for line in \
    open(os.path.join(ROOT_DIR, 'data/Lantmateriet/shape_names.txt'))] 

HOSTNAME = socket.gethostname()

# Shapenet official train/test split
# Checks if there are more points per sample than in the data set.
if FLAGS.normal:
    ...
    while TEST_DATASET.has_next_batch():
        ...
        for i in range(bsize):
            ...
            if pred_val[i] != l:
                    ...
                    output_img = pc_util.point_cloud_three_views(np.squeeze(cur_batch_data[i, :, :]))
