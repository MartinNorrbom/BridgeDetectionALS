...
if __name__ == '__main__':
   ...
   # d = PartNormalDataset(root = '../data/modelnet40_ply_hdf5_2048', split='trainval', npoints=3000)
    print(len(d))
   ...
   # d = PartNormalDataset(root = '../data/modelnet40_ply_hdf5_2048', classification = True)
    print(len(d))
    ps, normal, cls = d[0]
