...
hdf5_data_dir = os.path.join(BASE_DIR, '../part_seg')
...
# Creates a two dimensional vector for the object names and ID number.
...
TRAINING_FILE_LIST = os.path.join(hdf5_data_dir, '../data/Lantmateriet/segTrainFiles.txt')
TESTING_FILE_LIST = os.path.join(hdf5_data_dir, '../data/Lantmateriet/segTestFiles.txt')

# Creating folders for output logs.
    ...
    with tf.Graph().as_default():
        ...
        def train_one_epoch(train_file_idx, epoch_num):
            ...
            for i in range(num_train_file):
                ...
                # Import training file and randomize the order of the data.
        ...
        def eval_one_epoch(epoch_num):
            ...
            # for cat_idx in range(NUM_CATEGORIES): #TA BORT????
