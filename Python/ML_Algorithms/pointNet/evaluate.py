...
# Added new library to replace the way of saving images. MN
import imageio
...
# Don't think this line of code is doing nothing.
...
def eval_one_epoch(sess, ops, num_votes=1, topk=1):
    ...
    for fn in range(len(TEST_FILES)):
        ...
        for batch_idx in range(num_batches):
            ...
            # Vooting with different rotation.
            for vote_idx in range(num_votes):
                ...
                loss_val, pred_val = sess.run([ops['loss'], ops['pred']],
                                          feed_dict=feed_dict)
                print("pred_val:",str(pred_val[1]))

                # Get the sum of predictions.
            ...
            # The object is classified as the node with highest weight.
            ...
            # Save text logs, and images for all false classified samples.
            for i in range(start_idx, end_idx):
                ...
                if pred_val[i-start_idx] != l and FLAGS.visu: # ERROR CASE, DUMP!
                    ...
                    # Changed library to save images.
    ...
    # Log the accuracy for every class.
