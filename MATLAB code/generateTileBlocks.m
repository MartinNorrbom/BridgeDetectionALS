...
%       bridge or not.
    ...
    % Number of methods.
    nrGenerationMethods = size(generationMethod,2);
    ...
    for ii=1:nrLAZfiles
        ...
        if( ~isempty(selectedFile) )
            ...
            % Check if generation method 3 or 4 should be used in this file.
            if((generationMethod(ii,gCoord) == 1)||(generationMethod(ii,gTest) == 1) )
                ...
                if(extraFeature(2))
                    ...
                    if(generationMethod(ii,gCoord) == 1)
                        ...
                        [bufferPointCoord{ii,gCoord},bufferPointIntensity{ii,gCoord}, ...
                            ...
                            getBlockFromCoord(ptCloudObjects,ptAttrObjects,class, ...
                            tileBlockPointNumber,gridSize, flip(coordinates,2),"neighbours");
                        
                    end
                    
                    if(generationMethod(ii,gTest) == 1)
                        % Generate test data(method 4).
                        [bufferPointCoord{ii,gTest},bufferPointIntensity{ii,gTest}, ...
                            bufferPointReturnNumber{ii,gTest}, ...
                            bufferPointClass{ii,gTest},bufferTileBlockClass{ii,gTest}, ...
                            bufferBlockGeoCoord{ii,gTest}] = ...
                            getTestBlocks(ptCloudObjects,ptAttrObjects,class, ...
                            tileBlockPointNumber,gridSize,0);
                    end    
